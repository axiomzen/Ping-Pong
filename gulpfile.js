...
gulp.task('main.js', function() {
  ...
  bundle.add(paths.js + '/third_party/typekit.js', {
    noparse: true
  });
  ...
  function rebundle() {
    cleanJS(function() {
      return watch.bundle()
        ...
        // Exorcist extracts Browserify's inline source map and moves it to an external
        // file
...
gulp.task('sounds', function(cb) {
  ...
  async.parallel([
    ...
    var updateSprite = exec.bind(undefined,
      'audiosprite --format howler --path build/ --output ui/public/build/sprite --export mp3 ui/public/sounds/*.mp3 ui/public/sounds/*.wav',
      cb);
...
function getTTS(phrase, language, cb) {
  ...
  var
    requestURL = 'http://translate.google.com/translate_tts?q=' + phrase + '&tl=' +
    language,
